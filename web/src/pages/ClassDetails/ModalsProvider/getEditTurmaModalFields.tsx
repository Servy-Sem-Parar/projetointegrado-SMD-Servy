...
interface IGetEditTurmaModalFieldsProps {
...
export const turmasFieldValidations = {
    name: ["mandatory"],
    level: ["mandatory"],
    description: [],
    informations: [],
...
export function getEditTurmaModalFields(props: IGetEditTurmaModalFieldsProps) {
    const fields: IFormGroupProps[] = [
        {
            ...
            validations: turmasFieldValidations.name && turmasFieldValidations.name,
            placeholder: "",
            size: "100",
        ...
        },    
        {
            ...
            validations: turmasFieldValidations.level && turmasFieldValidations.level,
            placeholder: "",
            size: "100",
            setFieldValidation: props.setFieldValidation,
            onChange: (value: string | Date | string[])=>{
        ...
        }, 
        {
            ...
            validations: turmasFieldValidations.description && turmasFieldValidations.description,
            placeholder: "",
            size: "100",
            setFieldValidation: props.setFieldValidation,
            onChange: (value: string | Date | string[])=>{
        ...
        },  
        {
            ...
            validations: turmasFieldValidations.informations && turmasFieldValidations.informations,
            placeholder: "",
            size: "100",
            setFieldValidation: props.setFieldValidation,
            onChange: (value: string | Date | string[])=>{
        ...
        }, 
        {
            ...
            validations: turmasFieldValidations.disciplina && turmasFieldValidations.disciplina,
        ...
        },
        {
            ...
            validations: turmasFieldValidations.teachers && turmasFieldValidations.teachers,
        ...
        },
        {
            ...
            validations: turmasFieldValidations.students && turmasFieldValidations.students,
        ...
        },
        {
            ...
            validations: turmasFieldValidations.color && turmasFieldValidations.color,
            placeholder: "",
            size: "100",
            setFieldValidation: props.setFieldValidation,
            onChange: (value: string | Date | string[])=>{
